...
import type { Conversation, Theme, User, Message, GeneratedDocs, Document, DocumentType, DocumentVersion, SourcedDocument } from '../types';
                    ...
                    {activeTab === 'analysis' && (
                     ...
                     {activeTab === 'viz' && (
                        <Visualizations
                            ...
                            diagramType={diagramType} isAnalysisDocReady={!!generatedDocs.analysisDoc}
                        />
                     )}
                     {activeTab === 'test' && (
                        <DocumentCanvas
