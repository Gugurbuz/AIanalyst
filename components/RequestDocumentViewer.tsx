    ...
    return (
        <div className="p-4 md:p-8 h-full overflow-y-auto bg-white dark:bg-slate-900">
            <header className="border-b border-slate-200 dark:border-slate-700 pb-4 mb-6">
                <h1 className="text-3xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">{document.talepAdi}</h1>
                <div className="flex items-center flex-wrap gap-x-6 gap-y-2 mt-2 text-sm text-slate-500 dark:text-slate-400">
